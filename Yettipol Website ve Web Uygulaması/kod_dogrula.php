    ...
    <div class="container">
        ...
        <div class="girisvekayit">
            ...
            <section class="girisyapsayfasi3">
                ...
                <form id="kayitform" action="sifre_sifirla.php" method="POST">
                    <input type="hidden" name="email" value="<?php echo $_GET['email']; ?>">
                    <label>Kod:</label>
                    <input type="text" name="kod" required placeholder="Kod">
                    <label>Yeni Şifre:</label>
                    <input type="password" name="yeni_sifre" required placeholder="Yeni şifre">
