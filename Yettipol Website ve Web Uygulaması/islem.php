...
<body>
    <div class="container">
        ...
        <div class="icerik">
            ...
            <div class="islemsayfasi">
                ...
                <div class="hastalikgir">
                    <div class="islembaslik">
                        <h3>HASTALIKLAR</h3>
                        <button onclick="openModalCustom('hastalikModal')"> + Hastalık </button>
                    </div>
                ...
                <div class="recetegir">
                    <div class="islembaslik">
                        <h3>REÇETELER</h3>
                        <button onclick="openModalCustom('receteModal')"> + Reçete </button>
            ...
            <!-- HASTALIK MODAL -->
            <div id="hastalikModal" class="custom-modal">
                <div class="modal-content2">
                    <span class="close" onclick="closeModalCustom('hastalikModal')">&times;</span>
                    <h2>Hastalık Ekle</h2>
                    <form id="hastalikForm" action="hastalik_ekle.php" method="POST">
                        <div id="hastalikInputs">
                            <input type="hidden" name="tc_no" value="<?= $hasta_tc ?>">
                            <input type="hidden" name="tarih" value="<?= $randevu_tarih ?>">
                            <input type="hidden" name="saat" value="<?= $randevu_saat ?>">

                            <input type="text" name="hastalik[]" placeholder="Hastalık Adı" required />
                            <textarea name="hastalikAciklama[]" placeholder="Açıklama" rows="4"
                                required></textarea><br><br>
                        </div>
                        <button type="button" class="eklemebutonu"
                            onclick="ekleInput('hastalikInputs', 'Hastalık Adı')">+
                            Hastalık Ekle</button>
            ...
            <!-- REÇETE MODAL -->
            <div id="receteModal" class="custom-modal">
                <div class="modal-content2">
                    <span class="close" onclick="closeModalCustom('receteModal')">&times;</span>
                    <h2>Reçete Yaz</h2>
                    <form id="receteForm" action="recete_ekle.php" method="POST">
                        <input type="hidden" name="tc_no" value="<?= $hasta_tc ?>">
                        ...
                        <div id="ilacInputs">
                            <div class="ilac-item">
                                <div class="ilac-row">
                                    ...
                                    <textarea name="receteAciklama[]" placeholder="Açıklama" rows="4"
                                        required></textarea><br><br>
                        ...
                        <button type="button" class="eklemebutonu" onclick="ekleIlac()">+ İlaç Ekle</button>
                        <button type="submit" class="kaydetmebutonu">Kaydet</button>
                    </form>
                </div>
            </div>
