...
$sqlGelecek = "SELECT r.tc_no, k.hasta_isimsoyisim, k.hasta_dog_tar, k.hasta_cinsiyet,
               ...
               ORDER BY r.randevu_tarih, r.randevu_saat ASC";

$resultGelecek = $conn->query($sqlGelecek);
        ...
        <div class="icerik">
            ...
            <div class="gelecekrandevular">
                <div class="gelecekrand">
                    <div class="gelecek-kutusu-baslik">Gelecek Randevular</div>
                    ...
                    <?php while ($row = $resultGelecek->fetch_assoc()): ?>
