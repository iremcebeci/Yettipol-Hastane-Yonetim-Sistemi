    ...
    <div class="container">
        <header>
            ...
            <div class="menuButonlar2">
                <button><a href="girissizgoruntulu.php">Görüntülü Görüşme<br>Randevusu Al</a></button>
                <button><a href="girisyap.html">Giriş Yap</a></button>
            </div>
        </header>
        <div class="icerik">

            <form action="girissiz_randevu_kaydet.php" method="POST" class="randevu-al-form2">
                <div class="randevu-al-container2">
                    ...
                    <div class="randevu-takvimi-kutusu2">
                      ...
                      <label for='$tarih' class='gun-button'>$gosterilecek  {$gunler[$i]}</label><br>";
                        ...
                        <!-- Saat Seçimi -->
                        <fieldset class="saatbuttonkutu2">
