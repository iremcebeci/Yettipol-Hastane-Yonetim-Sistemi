...
// Saat kontrolü
if (!isset($_POST['saat'])) {
    echo "<script>alert('Lütfen bir saat seçin.'); window.location.href = 'girissizrandevu.php';</script>";
    exit;
}
$saat = $_POST['saat'];
...
$sqlRandevu = "INSERT INTO randevular (tc_no, doktor_id, hastane_id, bolum_id, randevu_tarih, randevu_saat, randevu_turu, randevu_durumu) 
               VALUES ('$ktcno', '$doktor_id', '$hastane_id', '$bolum_id', '$gun', '$saat', 'hastane', 'aktif')";
