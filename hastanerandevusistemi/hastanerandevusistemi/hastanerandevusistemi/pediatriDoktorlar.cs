...
{
    public partial class pediatriDoktorlar : UserControl
    {
        string secim;
        public string bolum = "Pediatri (Çocuk Sağlığı ve Hastalıkları)";
        public string hastane;
        public string randTipi = "Hastane randevusu";
        public string doktoradi;
        public pediatriDoktorlar(string secilenDeger)
        {
            InitializeComponent();
            this.Load += pediatriDoktorlar_Load;
        ...
        private void pediatriDoktorlar_Load(object sender, EventArgs e)
        {
