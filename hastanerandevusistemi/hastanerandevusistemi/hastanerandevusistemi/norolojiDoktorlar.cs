...
{
    public partial class norolojiDoktorlar : UserControl
    {
        string secim;
        public string bolum = "Nöroloji (Sinir Sistemi Hastalıkları)";
        public string hastane;
        public string randTipi = "Hastane randevusu";
        public string doktoradi;
        public norolojiDoktorlar(string secilenDeger)
        {
            InitializeComponent();
            this.Load += norolojiDoktorlar_Load;
        ...
        private void norolojiDoktorlar_Load(object sender, EventArgs e)
        {
