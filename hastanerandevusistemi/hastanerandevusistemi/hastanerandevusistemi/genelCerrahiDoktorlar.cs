...
{
    public partial class genelCerrahiDoktorlar : UserControl
    {
        string secim;
        public string bolum = "Genel Cerrahi";
        public string hastane;
        public string randTipi = "Hastane randevusu";
        public genelCerrahiDoktorlar(string secilenDeger)
        {
            InitializeComponent();
            this.Load += genelCerrahiDoktorlar_Load;
        ...
        private void genelCerrahiDoktorlar_Load(object sender, EventArgs e)
        {
