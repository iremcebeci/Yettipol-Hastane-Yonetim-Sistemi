...
{ 
    ...
    public partial class dokGelecekrandevular : UserControl
    {
        int doktorID;
        ...
        public dokGelecekrandevular(string tc)
        {
            InitializeComponent();
            this.tc = tc;
        }

        private async void  dokGelecekrandevular_Load(object sender, EventArgs e)
        {
        ...
        private void RandevulariGetir(int page)
        {
            ...
            using (MySqlConnection conn = new MySqlConnection(connectionString))
            {
                ...
                string query = $@"
                SELECT r.randevu_tarih, r.randevu_saat, h.tc_no, h.hasta_isimsoyisim, h.hasta_cinsiyet, h.hasta_dog_tar, r.doktor_id, r.randevu_durumu
                ...
                using (MySqlDataReader reader = cmd.ExecuteReader())
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        string bilgi = $" {tc}      {adsoyad}      {dogumtarihi:dd.MM.yyyy}       {cinsiyet}      {tarih:dd.MM.yyyy} {saat:HH:mm}    {durum}";
