...
{
    public partial class KBBDoktorlar : UserControl
    {
        string secim;
        public string bolum = "Kulak Burun Boğaz (KBB)";
        public string hastane;
        public string randTipi = "Hastane randevusu";
        public string doktoradi;
        public KBBDoktorlar(string secilenDeger)
        {
            InitializeComponent();
            this.Load += KBBDoktorlar_Load;
        ...
        private void KBBDoktorlar_Load(object sender, EventArgs e)
        {
