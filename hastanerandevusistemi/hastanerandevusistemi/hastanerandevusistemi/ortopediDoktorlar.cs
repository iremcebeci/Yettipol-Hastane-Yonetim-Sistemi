...
{
    public partial class ortopediDoktorlar : UserControl
    {
        string secim;
        public string bolum = "Ortopedi ve Travmatoloji";
        public string hastane;
        public string randTipi = "Hastane randevusu";
        public string doktoradi;
        public ortopediDoktorlar(string secilenDeger)
        {
            InitializeComponent();
            this.Load += ortopediDoktorlar_Load;
        ...
        private void ortopediDoktorlar_Load(object sender, EventArgs e)
        {
