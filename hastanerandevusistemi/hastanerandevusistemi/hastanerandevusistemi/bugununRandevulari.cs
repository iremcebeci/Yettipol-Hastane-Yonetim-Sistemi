...
{
    public partial class bugununRandevulari : UserControl
    {
        int doktorID;
        ...
        public bugununRandevulari(string tc)
        {
            InitializeComponent();
            this.tc = tc;
        }

        private async void bugununRandevulari_Load(object sender, EventArgs e)
        {
            ...
            using (MySqlConnection conn = new MySqlConnection(connectionString))
            {
                ...
                using (MySqlDataReader reader = cmd.ExecuteReader())
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        buton.Click += (s, e) =>
                        {
                            LoadUserControlIcerik(new hastaliklarimilaclarim(tc));
                        };
                        buton2.Click += (s, e) =>
                        {
                            LoadUserControlIcerik(new tahliller(hastatc));
                        };
